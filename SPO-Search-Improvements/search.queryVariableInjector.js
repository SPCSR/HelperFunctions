    ...
    (function (Search) {
        ...
        (function (VariableInjection) {
            ...
            function loadSynonyms() {
                ...
                var urlSynonymsList = _siteUrl + "/_api/Web/Lists/getByTitle('" + SynonymsList + "')/Items?$top=1000&$select=Title,Synonym,TwoWay";
                            ...
                            if (typeof data.d !== 'undefined') {
                                ...
                                if (results.length) {
                                    var _loop_1 = function (i) {
                                        var item = results[i];
                                        if (item.TwoWay) {
                                            var synonyms = splitSynonyms(item.Synonym);
            ...
            function formatSynonym(value) {
                value = value.trim().replace(/"/g, '').trim();
                value = '"' + value + '"';
                return value;
            }
            function formatSynonymsSearchQuery(items) {
                var result = '';
                    ...
                    if (queryParts) {
                        for (var i = 0; i < queryParts.length; i++) {
                            ...
                            if (value) {
                                ...
                                query = query.replace(queryParts[i], String.format('({0} OR {1})', formatSynonym(queryParts[i]), formatSynonymsSearchQuery(value)));
                                synonyms.push(value);
                            }
                        }
                    }
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(4), __webpack_require__(2)))
